% ============================================================
%  MaskedExpPseudoVoigt_Quad
%  진짜 피크(pG): Pseudo-Voigt (A, mean, FWHM, eta 자유)
%  배경 보조(pGB): Pseudo-Voigt 형태이나 eta=0 고정 → 순수 Gaussian
%  fittype/시각화: makePVExpFittype.m, PV_varargin.m 사용
...
% parameter 열: [b1 b2 b3, a1 m1 w1 e1, a2 m2 w2 e2, ...]
%   k번째 피크: amp=4k, mean=4k+1, FWHM=4k+2, eta=4k+3
